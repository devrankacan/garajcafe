...
export default function WaiterLoginPage() {
  ...
  return (
    <div className="felt-bg min-h-screen flex items-center justify-center px-4">
      {/* Dekoratif köşeler */}
      <div className="absolute top-6 left-6 text-3xl" style={{ color: "rgba(204,21,21,0.2)" }}>♠</div>
      <div className="absolute top-6 right-6 text-3xl" style={{ color: "rgba(204,21,21,0.2)" }}>♥</div>
      <div className="absolute bottom-6 left-6 text-3xl" style={{ color: "rgba(204,21,21,0.2)" }}>♦</div>
      <div className="absolute bottom-6 right-6 text-3xl" style={{ color: "rgba(204,21,21,0.2)" }}>♣</div>

      <div className="w-full max-w-sm fade-in">
        {/* Logo */}
        <div className="text-center mb-8">
          <p className="text-5xl mb-2" style={{ color: "#cc1515" }}>♠</p>
          <h1 className="text-2xl font-bold" style={{ color: "#cc1515" }}>Garson Girişi</h1>
        ...
        <form onSubmit={login} className="rounded-2xl overflow-hidden"
          style={{ background: "#1a1a1a", border: "1px solid rgba(204,21,21,0.35)" }}>
          <div className="p-6 space-y-4">
            <div>
              <label className="block text-xs font-semibold uppercase mb-1.5" style={{ color: "#cc1515" }}>Kullanıcı Adı</label>
              <input
                type="text"
                value={form.username}
